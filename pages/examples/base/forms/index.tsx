...
const BasicForms = () => {
  ...
  return (
    <>
      ...
      <CRow>
        <CCol xs="12">
          <CFade timeout={300} in={showElements} unmountOnExit>
            <CCard>
              <CCardHeader>
                Form Elements
                  ...
                  <CForm className="form-horizontal">
                    <CFormGroup>
                      ...
                      <div className="controls">
                        ...
                        <p className="help-block">Heres some help text</p>
                      </div>
                    </CFormGroup>
                    <CFormGroup>
                      ...
                      <div className="controls">
                        ...
                        <span className="help-block">Heres more help text</span>
                      </div>
                    </CFormGroup>
                    <CFormGroup>
                    ...
                    <CFormGroup>
                      <CLabel htmlFor="appendedInputButton">
                        Append with button
                      </CLabel>
                      <div className="controls">
                        <CInputGroup>
                    ...
                    <CFormGroup>
                      <CLabel htmlFor="appendedInputButtons">
                        Two-button append
                      </CLabel>
                      <div className="controls">
                        <CInputGroup>
